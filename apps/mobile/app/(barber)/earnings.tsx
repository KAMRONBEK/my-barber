// TODO: Implement the Barber Earnings screen.
//       Design reference: OD screen 17 — revenue chart, payout history table,
//       total balance card, and withdraw CTA.
//       Data source: GET /barber/earnings (endpoint not yet shipped).
    ...
    <ScreenLayout>
      ...
      <View style={styles.center}>
        <Text style={{ fontSize: 22, fontWeight: '700', color: theme.colors.fg }}>
          {/* TODO: add i18n key barber.earnings */}
          Earnings
        </Text>
