// TODO: Implement the Barber Pending Bookings screen.
//       Design reference: OD screen 16 — bookings in "pending" state awaiting
//       the barber's final confirmation before the slot is locked.
//       Data source: GET /barber/bookings?status=pending (endpoint not yet shipped).
    ...
    <ScreenLayout>
      ...
      <View style={styles.center}>
        <Text style={{ fontSize: 22, fontWeight: '700', color: theme.colors.fg }}>
          {/* TODO: add i18n key barber.pending */}
          Pending
        </Text>
